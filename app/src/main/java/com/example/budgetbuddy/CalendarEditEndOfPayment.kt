...
import com.example.budgetbuddy.databinding.FragmentCalendarEditEndOfPaymentBinding
...
class CalendarEditEndOfPayment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val calendarView : CalendarView =binding.calendarView34
        val confirmButton : Button =binding.confirmButtonFix34
        var nameV= ""
        var amountV=0.0
