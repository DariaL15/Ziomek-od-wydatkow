...
class RozrywkaHistoryFragment : Fragment() {



    private lateinit var recview: RecyclerView
    private lateinit var adapter: MyAdapter
    private lateinit var binding: FragmentRozrywkaHistoryBinding
    private lateinit var  datalist: ArrayList<Model>
    private lateinit var db: FirebaseFirestore
    private val userId = FirebaseAuth.getInstance().currentUser!!.uid
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentRozrywkaHistoryBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    companion object{
        fun newInstance(): RozrywkaHistoryFragment {
            return RozrywkaHistoryFragment()
        }
    }
